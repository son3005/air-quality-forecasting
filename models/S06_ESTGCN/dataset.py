...
RAW_FEATURES = [
    ...
    'oxidation_potential', 'pollution_load', 'no2_so2_log_diff', 'humid_sulfate_risk', 
    'thermal_stability', 'dust_source_potential', 'is_frozen', 'is_outlier', 
    'is_pm25_sensor_error', 'wind_sin', 'wind_cos'
]
