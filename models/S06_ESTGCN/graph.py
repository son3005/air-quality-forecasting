...
def get_adjacency_matrix(info_path='data/info.csv', selected_stations=None):
    ...
    # Filter info based on selected stations
    df_selected = df_info[df_info['station'].isin(selected_stations)].copy()
    
    # Create a mapping from station ID to its coordinates
    station_coords = {}
    ...
    # Using the standard deviation of valid distances to determine sigma
...
if __name__ == '__main__':
    ...
    print("Min value:", adj.min(), "Max value:", adj.max())
