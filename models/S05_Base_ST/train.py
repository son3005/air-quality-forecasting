...
def train_model(seq_len=24, pred_len=24, epochs=100, batch_size=64, patience=15):
    print("="*70)
    print(f"  S05: STGCN Baseline (Fair Benchmark S09)")
    ...
    save_path = "data/models_saved/baseline_stgcn_s05.pth"
    ...
    for r_name, sids in REGIONS.items():
        ...
        # Chích trạm ra: target_inv.shape = (samples, 24, region_nodes)
    ...
    # Summary
    print("\n" + "=" * 70)
    print("  FINAL BENCHMARK — S05 STGCN")
    print("=" * 70)
